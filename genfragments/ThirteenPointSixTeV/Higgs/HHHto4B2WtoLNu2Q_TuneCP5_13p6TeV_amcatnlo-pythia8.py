...
generator = cms.EDFilter(
    "Pythia8ConcurrentHadronizerFilter",
        ...
        processParameters = cms.vstring(
            'POWHEG:nFinal = 3',   # Number of final state particles (BEFORE THE DECAYS) in the LHE other than emitted extra parton
            '24:mMin = 0.05',
            '24:onMode = on',
            '25:m0 = 125.0',
            '25:onMode = off',
            ...
            'ResonanceDecayFilter:daughters = 5,5,5,5,1,1,11,12',
          ),
